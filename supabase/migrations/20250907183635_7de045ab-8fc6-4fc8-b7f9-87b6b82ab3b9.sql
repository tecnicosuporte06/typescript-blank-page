...
-- Now drop the old workspace_role function and create the new system_profile one
DROP FUNCTION IF EXISTS public.is_workspace_member(uuid, workspace_role) CASCADE;

-- Create the updated is_workspace_member function using system_profile enum
