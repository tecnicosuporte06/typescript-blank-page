-- Corrigir funções de permissão de automação para usar o tipo correto de role
-- O problema era que estava usando system_profile ao invés de workspace_role
...
BEGIN
  ...
  -- Usar 'colaborador' como role mínimo (a função is_workspace_member já verifica se é master)
  RETURN is_workspace_member(v_workspace_id, 'colaborador'::workspace_role);
END;
$$;
