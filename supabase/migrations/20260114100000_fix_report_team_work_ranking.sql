-- Corrige a função de ranking de trabalho para usar comparações mais flexíveis
-- Busca tanto com acentos quanto sem acentos para capturar todas as variações
-- Nota: tabela activities não tem coluna "status", apenas "type" e "subject"
