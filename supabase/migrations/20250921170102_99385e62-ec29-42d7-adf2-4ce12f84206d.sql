...
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS messages_workspace_external_id_key
  ON public.messages(workspace_id, external_id)
  WHERE external_id IS NOT NULL;

-- 2. Tags únicas por workspace
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS tags_workspace_name_unique_idx
