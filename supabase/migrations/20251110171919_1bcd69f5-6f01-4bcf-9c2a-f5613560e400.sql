...
ALTER TABLE pipeline_cards DISABLE TRIGGER trigger_log_pipeline_card_changes;
...
-- Recriar função com melhor tratamento de erro e logs
...
BEGIN
  ...
  BEGIN
    SELECT pc.pipeline_id INTO STRICT v_workspace_id
