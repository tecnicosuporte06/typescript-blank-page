...
export function EditarCargoModal({ isOpen, onClose, onEditCargo, cargo }: EditarCargoModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] bg-white border border-gray-200 rounded-lg shadow-lg p-8 overflow-y-auto dark:bg-[#0f0f0f] dark:border-gray-700 dark:text-gray-100">
        <DialogHeader className="mb-6">
          <DialogTitle className="text-lg font-normal text-gray-900 text-left dark:text-gray-100">
            Editar cargo
          </DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="relative">
              <input
                ...
                className="w-full h-12 pt-2 pb-2 px-3 border border-input text-sm ring-offset-background rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary bg-white text-black dark:bg-[#1a1a1a] dark:text-gray-100 dark:border-gray-700"
              />
              <label 
                ...
                style={{ backgroundColor: 'white', color: nomeIsFocused || nome ? undefined : undefined }}
              >
                Nome
              </label>
            </div>
            ...
            <div className="relative">
              <select 
                ...
                className="w-full h-12 pt-2 pb-2 px-3 border border-input text-sm ring-offset-background appearance-none rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary bg-white text-black dark:bg-[#1a1a1a] dark:text-gray-100 dark:border-gray-700"
              >
              ...
              <label 
                ...
                style={{ backgroundColor: 'white', color: tipoIsFocused || tipo ? undefined : undefined }}
              >
                Tipo de cargo
              </label>
          ...
          <div className="space-y-2">
            <label className="text-sm text-gray-600 font-normal dark:text-gray-300">Permissões de Acesso</label>
            <Collapsible open={isPermissionsOpen} onOpenChange={setIsPermissionsOpen}>
              <CollapsibleTrigger asChild>
                <Button
                  variant="outline"
                  className="w-full bg-white border border-gray-300 rounded-md px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 justify-between h-10 dark:bg-[#1a1a1a] dark:text-gray-100 dark:border-gray-700 dark:hover:bg-gray-800"
                  type="button"
                >
                  Permissões de Acesso
              ...
              <CollapsibleContent className="mt-3">
                <div className="bg-white border border-gray-200 rounded-md shadow-sm p-4 dark:bg-[#111111] dark:border-gray-700">
                  {/* Botões de ação */}
                  <div className="flex gap-2 mb-4">
                    <Button
                      ...
                      className="bg-background text-primary border-primary hover:bg-accent text-xs px-3 py-1 h-8 dark:bg-[#1a1a1a] dark:text-primary dark:border-primary"
                    >
                      Selecionar Tudo
                    </Button>
                    <Button
                  ...
                  <div className="space-y-2">
                    {permissoes.map((permissao) => (
                      <div key={permissao.id} className="border border-gray-200 rounded-md dark:border-gray-700">
                        {/* Header do módulo */}
                        <button
                          type="button"
                        ...
                        >
                          <span className="text-sm text-gray-700 font-normal dark:text-gray-200">
                            {permissao.label}
                          </span>
                              ...
                              <table className="w-full text-sm">
                                <thead>
                                  <tr className="border-b border-gray-200 dark:border-gray-700">
                                    <th className="text-left py-2 font-normal text-gray-600 dark:text-gray-300">Funcionalidade</th>
                                    <th className="text-center py-2 font-normal text-gray-600 dark:text-gray-300">Ver</th>
                                    <th className="text-center py-2 font-normal text-gray-600 dark:text-gray-300">Criar</th>
                                    <th className="text-center py-2 font-normal text-gray-600 dark:text-gray-300">Editar</th>
                                    <th className="text-center py-2 font-normal text-gray-600 dark:text-gray-300">Deletar</th>
                                  </tr>
                                </thead>
                                <tbody>
                                  {permissao.subPermissions.map(sub => (
                                    <tr key={sub.id} className="border-b border-gray-100 dark:border-gray-800">
                                      <td className="py-2 text-gray-700 dark:text-gray-200">{sub.label}</td>
          ...
          <div className="flex justify-end gap-3 pt-4">
            <Button
              ...
              variant="outline"
              onClick={onClose}
              className="bg-transparent border border-red-500 text-red-500 hover:bg-red-50 px-6 py-2 rounded-md text-sm font-normal dark:hover:bg-red-500/10"
            >
              Cancelar
            </Button>
            <Button
